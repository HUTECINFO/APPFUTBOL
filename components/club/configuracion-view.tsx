...
export function ConfiguracionView({ club, role }: ConfiguracionViewProps) {
  ...
  const [form, setForm] = useState({
    ...
    feeMensual: club.feeMensual && Number(club.feeMensual) > 0 ? Number(club.feeMensual).toString() : "1200",
      ...
      <Tabs defaultValue="general" className="space-y-6">
        ...
        <TabsContent value="finanzas">
          ...
          >
            <Card className="glass-panel p-6 space-y-6">
              <div>
                <h3 className="font-display text-xl font-semibold text-white">Cobro de mensualidades</h3>
                <p className="mt-1 text-sm text-white/50">El club define lo que paga cada alumno. Club One solo calcula su porcentaje de plataforma dentro de ese cobro.</p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <Label>Mensualidad base por jugador (MXN)</Label>
                  <Input
                    type="number"
